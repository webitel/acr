...
var Event = module.exports = function(type, subclass) {
    ...
    //case were we have headers/body
        ...
        for (var key in type) {
            if (type.hasOwnProperty(key) && key != '_body') {
...
Event.prototype.getHeader = function(name) {
    return this.headers.hasOwnProperty(name) ? this.headers[name] : null;
};
...
Event.prototype.nextHeader = function() {
    ...
    var _h = Object.keys(this.headers);
    //if reached end
    if(this.hPtr === (_h.length - 1)) {
        this.hPtr = null;
        return null;
    };
...
Event.prototype._findHeaderIndex = function(name) {
    var i = Object.keys(this.headers).indexOf(name);
    return i == -1 ? null : i;
};
